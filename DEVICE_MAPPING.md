...
| TARGET_TEMP | D0310E | 1-37°C (auto mode only) |
...
### Mode Detection
```python
if not POWER: return OFF
elif OPERATING_MODE == 0 or HEATING_STATUS == -16: return AUTO
elif OPERATING_MODE == -127: return FAN_ONLY
else: return HEAT
```
...
| 67 | HEATING | Medium (auto mode only) |
| -16 | IDLE | Auto target reached |